...
enum vp8e_enc_control_id {
  ...
  /*!\brief Codec control function to validate HDB input.
   *
   * Vp9 allows the encoder to validate the HDB input and ensure that every
   * pixel is within the valid range. To enable, set this parameter to be
   * 1. The default value is set to be 1.
   *
   * Supported in codecs: VP9
   */
  VP9E_SET_VALIDATE_INPUT_HDB,
};
...
VPX_CTRL_USE_TYPE(VP9E_SET_VALIDATE_INPUT_HDB, int)
#define VPX_CTRL_VP9E_SET_VALIDATE_INPUT_HDB
