...
enum vp8e_enc_control_id {
   ...
   *
   * Vp9 allows the encoder to validate the HBD input and ensure that every
   * pixel is within the valid range. To disable/enable, set this parameter
   * to 0/1. The default value is set to be 1.
   *
   * Supported in codecs: VP9
   */
