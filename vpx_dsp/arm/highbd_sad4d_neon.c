...
static INLINE void highbd_sad16xhx4d_neon(const uint8_t *src_ptr,
  ...
  int i = 0;
  do {
    uint16x8_t sum_lo_u16[4] = { vdupq_n_u16(0), vdupq_n_u16(0), vdupq_n_u16(0),
                                 vdupq_n_u16(0) };
    uint16x8_t sum_hi_u16[4] = { vdupq_n_u16(0), vdupq_n_u16(0), vdupq_n_u16(0),
                                 vdupq_n_u16(0) };
    do {
      uint16x8_t s0 = vld1q_u16(src16_ptr + i * src_stride);
      sum_lo_u16[0] =
          vabaq_u16(sum_lo_u16[0], s0, vld1q_u16(ref16_ptr0 + i * ref_stride));
      sum_lo_u16[1] =
          vabaq_u16(sum_lo_u16[1], s0, vld1q_u16(ref16_ptr1 + i * ref_stride));
      sum_lo_u16[2] =
          vabaq_u16(sum_lo_u16[2], s0, vld1q_u16(ref16_ptr2 + i * ref_stride));
      sum_lo_u16[3] =
          vabaq_u16(sum_lo_u16[3], s0, vld1q_u16(ref16_ptr3 + i * ref_stride));

      uint16x8_t s1 = vld1q_u16(src16_ptr + i * src_stride + 8);
      sum_hi_u16[0] = vabaq_u16(sum_hi_u16[0], s1,
                                vld1q_u16(ref16_ptr0 + i * ref_stride + 8));
      sum_hi_u16[1] = vabaq_u16(sum_hi_u16[1], s1,
                                vld1q_u16(ref16_ptr1 + i * ref_stride + 8));
      sum_hi_u16[2] = vabaq_u16(sum_hi_u16[2], s1,
                                vld1q_u16(ref16_ptr2 + i * ref_stride + 8));
      sum_hi_u16[3] = vabaq_u16(sum_hi_u16[3], s1,
                                vld1q_u16(ref16_ptr3 + i * ref_stride + 8));

    } while (++i < h_tmp);

    sum_u32[0] = vpadalq_u16(sum_u32[0], sum_lo_u16[0]);
    sum_u32[1] = vpadalq_u16(sum_u32[1], sum_lo_u16[1]);
    sum_u32[2] = vpadalq_u16(sum_u32[2], sum_lo_u16[2]);
    sum_u32[3] = vpadalq_u16(sum_u32[3], sum_lo_u16[3]);
    sum_u32[0] = vpadalq_u16(sum_u32[0], sum_hi_u16[0]);
    sum_u32[1] = vpadalq_u16(sum_u32[1], sum_hi_u16[1]);
    sum_u32[2] = vpadalq_u16(sum_u32[2], sum_hi_u16[2]);
    sum_u32[3] = vpadalq_u16(sum_u32[3], sum_hi_u16[3]);
  ...
  do {
    ...
    do {
      ...
      do {
        ...
        sum_lo_u16[0] = vabaq_u16(sum_lo_u16[0], s0,
                                  vld1q_u16(ref16_ptr0 + i * ref_stride + j));
        sum_lo_u16[1] = vabaq_u16(sum_lo_u16[1], s0,
                                  vld1q_u16(ref16_ptr1 + i * ref_stride + j));
        sum_lo_u16[2] = vabaq_u16(sum_lo_u16[2], s0,
                                  vld1q_u16(ref16_ptr2 + i * ref_stride + j));
        sum_lo_u16[3] = vabaq_u16(sum_lo_u16[3], s0,
                                  vld1q_u16(ref16_ptr3 + i * ref_stride + j));

        uint16x8_t s1 = vld1q_u16(src16_ptr + i * src_stride + j + 8);
        sum_hi_u16[0] = vabaq_u16(
            sum_hi_u16[0], s1, vld1q_u16(ref16_ptr0 + i * ref_stride + j + 8));
        sum_hi_u16[1] = vabaq_u16(
            sum_hi_u16[1], s1, vld1q_u16(ref16_ptr1 + i * ref_stride + j + 8));
        sum_hi_u16[2] = vabaq_u16(
            sum_hi_u16[2], s1, vld1q_u16(ref16_ptr2 + i * ref_stride + j + 8));
        sum_hi_u16[3] = vabaq_u16(
            sum_hi_u16[3], s1, vld1q_u16(ref16_ptr3 + i * ref_stride + j + 8));

        uint16x8_t s2 = vld1q_u16(src16_ptr + i * src_stride + j + 16);
        sum_lo_u16[0] = vabaq_u16(
            sum_lo_u16[0], s2, vld1q_u16(ref16_ptr0 + i * ref_stride + j + 16));
        sum_lo_u16[1] = vabaq_u16(
            sum_lo_u16[1], s2, vld1q_u16(ref16_ptr1 + i * ref_stride + j + 16));
        sum_lo_u16[2] = vabaq_u16(
            sum_lo_u16[2], s2, vld1q_u16(ref16_ptr2 + i * ref_stride + j + 16));
        sum_lo_u16[3] = vabaq_u16(
            sum_lo_u16[3], s2, vld1q_u16(ref16_ptr3 + i * ref_stride + j + 16));

        uint16x8_t s3 = vld1q_u16(src16_ptr + i * src_stride + j + 24);
        sum_hi_u16[0] = vabaq_u16(
            sum_hi_u16[0], s3, vld1q_u16(ref16_ptr0 + i * ref_stride + j + 24));
        sum_hi_u16[1] = vabaq_u16(
            sum_hi_u16[1], s3, vld1q_u16(ref16_ptr1 + i * ref_stride + j + 24));
        sum_hi_u16[2] = vabaq_u16(
            sum_hi_u16[2], s3, vld1q_u16(ref16_ptr2 + i * ref_stride + j + 24));
        sum_hi_u16[3] = vabaq_u16(
            sum_hi_u16[3], s3, vld1q_u16(ref16_ptr3 + i * ref_stride + j + 24));
