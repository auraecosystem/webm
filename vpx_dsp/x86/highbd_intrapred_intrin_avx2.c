...
static INLINE __m256i alignr2_epu16_256(__m256i hi, __m256i lo, int i) {
  __m256i mid = _mm256_permute2x128_si256(hi, lo, 3);
  // palignr in AVX2 operates in-lane
  // hi: hi_hi | hi_lo
  // mid hi_lo | lo_hi
  // lo: lo_hi | lo_lo
  // return: ((hi_lo | lo_hi) >> i)[0-15] | ((lo_hi | lo_lo) >> i)[0-15]
  return _mm256_alignr_epi8(mid, lo, i);
}
...
void vpx_highbd_d63_predictor_32x32_avx2(uint16_t *dst, ptrdiff_t stride,
  ...
  __m256i B0 = alignr2_epu16_256(A1, A0, 2);
  __m256i B1 = alignr2_epu16_256(AR, A1, 2);

  __m256i C0 = alignr2_epu16_256(A1, A0, 4);
  __m256i C1 = alignr2_epu16_256(AR, A1, 4);
  ...
  for (int i = 0; i < 30; i += 2) {
    ...
    avg2_0 = alignr2_epu16_256(avg2_1, avg2_0, 2);
    avg2_1 = alignr2_epu16_256(AR, avg2_1, 2);
    avg3_0 = alignr2_epu16_256(avg3_1, avg3_0, 2);
    avg3_1 = alignr2_epu16_256(AR, avg3_1, 2);
  }
