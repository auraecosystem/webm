...
// on second frames, with the timestamp (pts) parameter inconsistent
// with the duration (i..e, pts != prev_pts + duration). This reproduces
// the issue found in the bug: 431520320.
TEST(EncodeAPI, Vp8ChromiumIssue431520320) {
  ...
  // Encode third frame.
  ASSERT_EQ(vpx_codec_encode(&enc, image, 120000, /*duration=*/40000, 0,
                             VPX_DL_REALTIME),
            VPX_CODEC_OK);
