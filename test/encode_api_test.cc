...
// This tests sets 2 tile_rows with height corresponding to 1 superblock (sb).
TEST(EncodeAPI, Buganizer442105459_2RowTiles) {
  ...
  // Configure encoder
  cfg.g_w = 946u;
  cfg.g_h = 64u;  // 1 sb row, 2 tiles_rows set below.
  cfg.g_threads = 1;
  cfg.g_profile = 0;
  cfg.g_bit_depth = VPX_BITS_8;
...
// very first encoded frame since lag_in_frames = 0. Issue is due to enabling
// TILE_ROWS, with number of tile_rows more than the number of superblocks.
// This tests sets 4 tile_rows with height corresponding to 3 superblocks.
TEST(EncodeAPI, Buganizer442105459_4RowTiles) {
  ...
  // Configure encoder
  cfg.g_w = 946u;
  cfg.g_h = 192u;  // 3 sb rows, 4 tiles_rows set below.
  cfg.g_threads = 1;
  cfg.g_profile = 0;
  cfg.g_bit_depth = VPX_BITS_8;
  // Rate control targeting deeper encoding paths
