...
constexpr std::array<const char *, 12> kVP9FailingTestVectors = {
...
constexpr std::array<const char *, 37> kVP9InvalidFiles = {
  ...
  "invalid-vp90-2-09-subpixel-00.ivf.s19552_r01-05_b6-.ivf",
