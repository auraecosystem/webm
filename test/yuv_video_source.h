...
class YUVVideoSource : public VideoSource {
 public:
  ...
  virtual void FillFrame() {
    ...
    // If vpx_img_alloc() pads the row, for example to a power of 2 when width
    // is odd, the YUV data needs to be read row-wise in this case to ensure
    // the planes refer to the correct data.
