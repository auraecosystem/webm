...
static void build_intra_predictors_high(
  ...
  DECLARE_ALIGNED(64, uint16_t, left_col[32]);
  DECLARE_ALIGNED(64, uint16_t, above_data[64 + 32]);
...
static void build_intra_predictors(const MACROBLOCKD *xd, const uint8_t *ref,
                                   ...
                                   int plane) {
  int i;
  DECLARE_ALIGNED(32, uint8_t, left_col[32]);
  DECLARE_ALIGNED(32, uint8_t, above_data[64 + 32]);
