...
#if __has_feature(__builtin_assume)
// This is verified by test/vp9_scan_test.cc
#define ASSUME_VALID_SCAN_VALUE(i) __builtin_assume(i <= MAX_SCAN_VALUE)
#else
...
#endif
#else
#define ASSUME_VALID_SCAN_VALUE(i) assert(i <= MAX_SCAN_VALUE)
#endif
